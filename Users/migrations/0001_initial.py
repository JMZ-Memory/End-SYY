    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, upload_to='icon/', verbose_name='头像')),
                ('phone', models.CharField(blank=True, max_length=32, verbose_name='手机号')),
                ('is_first_modify', models.BooleanField(default=False, verbose_name='是否第一次修改')),
                ...
                ('signature', models.TextField(null=True, verbose_name='我的签名')),
